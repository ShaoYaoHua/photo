<template>
	<view>
		<!-- 顶部导航 -->
		<fa-navbar title="我的收藏"></fa-navbar>
		...
		<!-- 为空 -->
		<view class="u-m-t-60 u-p-t-60 u-p-b-60" v-if="is_empty"><u-empty text="您还没有收藏哦..." mode="list"></u-empty></view>
		<!-- 更多 -->
...
export default {
	...
	methods: {
		//列表
		getCollection() {
			this.$api.getCollection({ page: this.page }).then(res => {
