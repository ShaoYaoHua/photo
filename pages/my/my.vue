<template>
	<view>
		...
		<view class="u-flex u-text-center u-p-l-30 u-p-r-30 u-p-t-50 u-p-b-50 u-bg-white">
			<view class="u-flex-4" @click="goPage('/pages/logs/money', true)">
			...
			<view class="u-flex-4 u-border-left u-border-right" @click="goPage('/pages/logs/score', true)">
		...
		<view class="u-m-t-30">
			<u-cell-group>
				...
				<u-cell-item icon="order" title="我的消费订单" @click="goPage('/pages/my/myorder', true)"></u-cell-item>
				<u-cell-item icon="pushpin-fill" title="每日一签" @click="goPage('/pages/signin/signin', true)"></u-cell-item>
				<u-cell-item icon="edit-pen-fill" title="我发布的文章" @click="goPage('/pages/publish/myarticle', true)"></u-cell-item>
